 ...
 */
package com.helger.cipa.transport.start.jmssender.jetty;
 ...
 */
@Immutable
public final class RunInJettyCSJ
{
  private static final Logger s_aLogger = LoggerFactory.getLogger (RunInJettyCSJ.class);
  ...
  public static void run (final int nPort) throws Exception
  {
    ...
    aWebAppCtx.setTempDirectory (new File (SystemProperties.getTmpDir () + '/' + RunInJettyCSJ.class.getName ()));
