 ...
 * To stop the running Jetty simply invoke the {@link JettyStopAS4} application
...
{
  private static final Logger s_aLogger = LoggerFactory.getLogger (RunInJettyAS4.class);
  ...
  public static void main (final String... args) throws Exception
  {
    ...
    aWebAppCtx.setTempDirectory (new File (SystemProperties.getTmpDir () + '/' + RunInJettyAS4.class.getName ()));
