...
public class ElementProperties
{
  ...
  {
    previousElementNames = new LinkedList<> ();

  }

  public String elementName = null;
  // Is this element part of a composite sequence, but not the first sibling in
  // this sequence
  ...
  // Does the type definition of this node contain an attribute with name
  // composite
