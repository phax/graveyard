...
public class X12SimpleParserSpecialCharsTest
{
  ...
  public void testParseFile () throws EDIFormatException, IOException
  {
    ...
    final URL url = this.getClass ().getResource ("/example/example835SpecialCharsOne.txt");
  ...
  {
    final IX12Parser parser = new X12SimpleParser ();
    final InputStream is = this.getClass ().getResourceAsStream ("/example/example835SpecialCharsOne.txt");
