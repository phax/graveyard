...
import com.helger.lamaweb.app.layout.view.ViewMenuProvider;
import com.helger.photon.core.ajax.executor.AbstractAjaxExecutor;
import com.helger.photon.core.ajax.response.AjaxHtmlResponse;
import com.helger.photon.core.app.context.LayoutExecutionContext;
import com.helger.web.scope.IRequestWebScopeWithoutResponse;

public final class AjaxExecutorViewUpdateMenuView extends AbstractAjaxExecutor
{
  @Override
  @Nonnull
  protected AjaxHtmlResponse mainHandleRequest (@Nonnull final IRequestWebScopeWithoutResponse aRequestScope) throws Exception
  {
    ...
    final IHCNode aRoot = ViewMenuProvider.getContent (aLEC);
