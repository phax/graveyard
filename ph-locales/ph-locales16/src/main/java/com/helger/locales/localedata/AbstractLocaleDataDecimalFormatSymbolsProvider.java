...
public abstract class AbstractLocaleDataDecimalFormatSymbolsProvider extends DecimalFormatSymbolsProvider
{
  /**
  ...
  @Override
  public final DecimalFormatSymbols getInstance (final Locale aLocale)
  {
    getLocaleData ().checkLocaleSupported (aLocale);

    return new LocaleDataDecimalFormatSymbols (getLocaleData ());
  }
