...
public abstract class AbstractLocaleDataDateFormatSymbolsProvider extends DateFormatSymbolsProvider
{
  /**
  ...
  @Override
  public final DateFormatSymbols getInstance (final Locale aLocale)
  {
    getLocaleData ().checkLocaleSupported (aLocale);

    return new LocaleDataDateFormatSymbols (getLocaleData ());
  }
