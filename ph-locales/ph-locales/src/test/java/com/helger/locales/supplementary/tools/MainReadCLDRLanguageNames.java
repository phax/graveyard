...
public class MainReadCLDRLanguageNames extends AbstractCLDRSupport
{
  private static final Logger s_aLogger = LoggerFactory.getLogger (MainReadCLDRLanguageNames.class);

  public static void main (final String [] args)
  {
    final String sLocale = "sr_Latn";
    ...
    for (final IMicroElement e : aDoc.getDocumentElement ()
                                     .getFirstChildElement ("localeDisplayNames")
                                     .getFirstChildElement ("languages")
                                     .getAllChildElements ("language"))
    {
      final String sType = e.getAttributeValue ("type");
      // Use only language codes (no variants)
