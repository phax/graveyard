...
import com.helger.dee.api.channel.out.IOutChannel;
...
public interface IOutgoingDocument extends IDocument
{
  @Nonnull
  ...
  @Nonnull
  IOutgoingDocumentValidationResult getOutgoingDocumentValidationResult ();

  @Nonnull
  LocalDateTime getOutgoingDateTime ();

  @Nonnull
  IOutChannel getOutChannel ();

  @Nonnull
  IPartner getReceivingPartner ();

  @Nonnegative
  long getSendingProcessingMilliseconds ();
}
